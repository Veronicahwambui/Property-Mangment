        ...
        <div class="card">
            ...
            <div class="card-body border-top">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mt-0 pt-0">
                            <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-danger"></i>Units serving notice</p>
                            <h5><span>32 Units/Houses</span>
                            </h5>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mt-2 pt-0">
                            <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-warning"></i> Agreements to be renewed this month</p>
                            <h5>23 Units</h5>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 col-sm-3 col-md-2">
                                            <div>
                                                ...
                                                <p class="text-muted text-truncate mb-2">vacant Houses</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-muted mt-4">
                                    <h4>KES 23,526<i class="mdi mdi-chevron-up ms-1 text-success"></i></h4>
                                    <div class="d-flex">
                                        <span class="text-truncate">From 32 Unpaid Invoices</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-muted mt-4">
                                    <h4 class="text-uppercase">kes 2,325<i class="mdi mdi-chevron-up ms-1 text-success"></i></h4>
                                    <div class="d-flex">
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-muted mt-4">
                                    <h4 class="text-uppercase">KES 2,321,326<i class="mdi mdi-chevron-up ms-1 text-success"></i></h4>

                                    <div class="d-flex">
                                        <span class="badge badge-soft-success font-size-12"> 2% </span> <span class="ms-2 text-truncate">From previous period</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item py-3">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="align-self-center overflow-hidden me-auto">
                                                                    <div>
                                                                        <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Zone A (Nairobi)</a></h5>
                                                                        <p class="text-muted mb-0">22 units</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="list-group-item py-3">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="align-self-center overflow-hidden me-auto">
                                                                    <div>
                                                                        <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Zone B (Nakuru)</a></h5>
                                                                        <p class="text-muted mb-0">78 units</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="list-group-item py-3">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="align-self-center overflow-hidden me-auto">
                                                                    <div>
                                                                        <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Zone c (Nakuru)</a></h5>
                                                                        <p class="text-muted mb-0">26 units</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="list-group-item py-3">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="align-self-center overflow-hidden me-auto">
                                                                    <div>
                                                                        <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Zone T (Nairobi)</a></h5>
                                                                        <p class="text-muted mb-0">64 Units</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="list-group-item py-3">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="align-self-center overflow-hidden me-auto">
                                                                    <div>
                                                                        <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Zone 24 (Nakuru)</a></h5>
                                                                        <p class="text-muted mb-0">123 units</p>
                                                                    </div>
                                                                </div>
                ...
                <div class="card">
                    <div class="card-header bg-transparent border-bottom">
                        <div class="d-flex flex-wrap align-items-start">
                            <div class="me-2">
                                <h5 class="card-title mt-1 mb-0">Revenue by Hse Type</h5>
                                <div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom card-header-tabs ms-auto" role="tablist">
                                <li class="mr-3 me-3">
                                    <select class="form-control selectpicker" data-live-search="true" data-style="btn-primary btn-sm" title="Select Month">
                                            
                                        <option value="Jan 2022" selected>Jan 2022</option>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#by-all" role="tab">
                                        All Counties
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#by-nairobi" role="tab">
                                        Nairobi
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#by-nakuru" role="tab">
                                        Nakuru
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="card-body">
                        ...
                        <div data-simplebar="init" style={{maxHeight: "410px"}}>
                                        ...
                                        <div class="simplebar-content-wrapper" style={{height: "auto" , overflow: "hidden scroll"}}>
                                            <div class="simplebar-content" style={{padding: "0px"}}>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="by-all" role="tabpanel">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">One Bedrooms</a></h5>
                                                                            <p class="text-muted mb-0">21 units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">One Bedrooms</a></h5>
                                                                            <p class="text-muted mb-0">18 units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Two Bedrooms</a></h5>
                                                                            <p class="text-muted mb-0">16 units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Bed Sitters</a></h5>
                                                                            <p class="text-muted mb-0">61 Units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Four Bedrooms</a></h5>
                                                                            <p class="text-muted mb-0">113 units</p>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    {/* <!-- end tab pane --> */}
                                                    <div class="tab-pane" id="by-nairobi" role="tabpanel">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                    ...
                                                    <div class="tab-pane" id="by-nakuru" role="tabpanel">
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Bed sitter</a></h5>
                                                                            <p class="text-muted mb-0">66 units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">One Bedrooms</a></h5>
                                                                            <p class="text-muted mb-0">54 units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Two Bedrooms</a></h5>
                                                                            <p class="text-muted mb-0">212 units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">Three Bedroom</a></h5>
                                                                            <p class="text-muted mb-0">122 units</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item py-3">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="align-self-center overflow-hidden me-auto">
                                                                        <div>
                                                                            <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);" class="text-dark">One Bedrooms</a></h5>
                                                                            <p class="text-muted mb-0">315 units</p>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="simplebar-track simplebar-vertical" style={{visibility: "visible"}}>
                                <div class="simplebar-scrollbar" style={{height: "269px", transform: "translate3d(0px, 26px, 0px)" , display: "block"}}></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-5 px-sm-30px">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 align-self-center">
                        <div>
                            <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-primary"></i> Residential</p>
                            <h5>KES 22,562 <br/><span class="text-muted font-size-12">23 Contacts</span></h5>
                        </div>

                        <div class="mt-4 pt-2">
                            <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-pink"></i> Commercial</p>
                            <h5>KES 632,230 <br/>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <div id="agrement-type" class="apex-charts revenue-type"></div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="mt-4 text-left">
                                <p class="mb-2 text-truncate text-left"><i class="mdi mdi-circle text-primary me-1"></i>Agreement Fees</p>
                                <h5>KES 202,132</h5>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mt-4 text-left">
                                <p class="mb-2 text-truncate"><i class="mdi mdi-circle text-danger me-1"></i>Surcharge</p>
                                <h5>KES 21,763</h5>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mt-4 text-left">
                                <p class="mb-2 text-truncate text-left"><i class="mdi mdi-circle text-primary me-1"></i>Commission</p>
                                <h5>KES 30,256</h5>
                            </div>
                        </div>

...
function AllRoles() {
  ...
  return (
    <>
                ...
                <div class="card-header bg-white pt-0 pr-0 p-0 d-flex justify-content-between align-items-center w-100 border-bottom">
                  ...
                  <div class="btn-toolbar p-3 d-flex justify-content-between align-items-center w-100" role="toolbar">
                    ...
                    <div class="d-flex">
                      ...
                      <button type="button" class="btn btn-primary waves-effect btn-label waves-light me-3" data-bs-toggle="modal" data-bs-target="#add-new-role">
      ...
      {/* <!-- adding roles modal --> */}
      <div class="modal fade" id="add-new-role" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <form onSubmit={(e) => { e.preventDefault(); AddARole() }}>
              <div class="modal-header">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" data-bs-dismiss="modavxbxcvd" >Save</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="modal fade" id="edit-role" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
          <form onSubmit={(e) => { e.preventDefault(); editARole() }}>

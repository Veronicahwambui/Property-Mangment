...
export default function NewClient() {
  ...
  const handleSubmit = (event) => {
    ...
    requestsServiceService.createClient(clientdata, isChecked).then((res) => {
      console.log(res);
          ...
          <div className="row">
            <div className="col-12">
              <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 className="mb-sm-0 font-size-18 text-capitalize">Client Registration</h4>

                <div className="page-title-right">
                  <ol className="breadcrumb m-0">
                    <li className="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li className="breadcrumb-item"><a href="property-list.html">Clients</a></li>
                  ...
                  <div className="create-property" id="kev-step-form">
                      ...
                      <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto">
                          <li className="nav-item active">
                            <a className="nav-link active" href="#">1. Client details <span
                    ...
                    <form id="client-form" onSubmit={handleSubmit}>
                      <section className={"step-cont active-step"}>
                        ...
                        <div className="col-12">
                          <div className="bg-primary border-2 bg-soft p-3 mb-4">
                            <p className="fw-semibold mb-0 pb-0 text-uppercase">Client details</p>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="mb-3">
                              <label htmlFor="landlord-type" className="form-label">Client type.  <strong className="text-danger">*</strong></label>
                              {clientTypes &&
                              <div className="form-group mb-4">
                                <select className="form-control" onChange={(e) => setClientTypeId(e.target.value)}  required={true}>
                                  <option className="text-black font-semibold ">
                                    Select client type
                                  </option>
                                  {
                                    clientTypes.map((client, index) => (
                                      <option key={client.id} value={parseInt(client.id)}>{client.name}</option>
                                    ))
                                  }
                                </select>
                              </div>
                        ...
                        <div className="row personal-landlord ">
                          ...
                          <div className="col-lg-6 col-md-6 ">
                            <div className="mb-4">
                              ...
                              <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="form-control"
                                     placeholder="Enter client name" required={true}/>
                            </div>
                          </div>
                          <div className="col-lg-6 col-md-6 ">
                            <div className="mb-4">
                              <label htmlFor="">URL. <strong className="text-danger">*</strong></label>
                              <input type="url" value={clientUrl} onChange={(e) => setClientUrl(e.target.value)}
                                     className="form-control"
                                     placeholder="Enter client url"  required={true} />
                            </div>
                          </div>
                          ...
                          <div className="col-12">
                            <div className="bg-primary border-2 bg-soft p-3 mb-4">
                              <p className="fw-semibold mb-0 pb-0 text-uppercase">Admin details</p>
                            </div>
                            <div className="row">
                              <div className="col-6">
                                <div className="form-group mb-4">
                                  ...
                                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                                         className="form-control"
                                         placeholder="Enter admin email" required={true} />
                                </div>
                                <div className="form-group mb-4">
                                  <label htmlFor="">Username. <strong className="text-danger">*</strong></label>
                                  <input type="text" value={username} onChange={(e) => setUsername(e.target.value)}
                                         className="form-control"
                                         placeholder="Enter admin username" required={true} />
                                </div>
                                <div className="form-group mb-4">
                      ...
                      <section className={"step-cont d-none"}>
                        <div className="col-12">
                          <div className="bg-primary border-2 bg-soft p-3 mb-4">
                            <p className="fw-semibold mb-0 pb-0 text-uppercase">CLIENT ACCOUNT DETAILS
                            </p>
                          </div>
                                    ...
                                    <td className="text-right cell-change text-nowrap ">
                                      <div className="d-flex">
                                        <a data-bs-toggle="modal"
                                           onClick={() => getOneAccount(account.bankId)}
                    ...
                    <div className="button-navigators">
                      ...
                      <button type='submit' className="btn btn-success kev-submit me-2 d-none" form={"client-form"}>Submit <i className="mdi mdi-check-all me-2 font-16px"></i></button>
                    </div>
                  </div>
                </div>
              </div>

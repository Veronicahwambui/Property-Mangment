                ...
                <div className="btn-toolbar p-3 d-flex justify-content-between align-items-center w-100"
                  ...
                  <div className="d-flex">
                    <button type="button"
                      ...
                      className="pl-1 d-md-inline">Edit client details</span>
                    </button>
                  </div>
                </div>
              </div>
              <div className="card calc-h-3px">
                <div className={"d-flex"}>
                  <div className="card-body border-top">
                    <p className="p-0 m-0"><span className="text-muted">Name. </span>{client?.name}</p>
                  </div>
                  <div className="card-body border-top">
                    <p className="p-0 m-0"><span className="text-muted">URL. </span>{client?.clientBaseUrl}</p>
                  </div>
                  <div className="card-body border-top">
                    <p className="p-0 m-0"><span className="text-muted">Vacancy Restriction Status. </span>{client?.unitVacancyRestrictionStatus}</p>
                  </div>
                  <div className="card-body border-top">
                    <p className="p-0 m-0"><span className="text-muted">Client Type. </span>{clientType?.name}</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    {/*UPDATE CLIENT MODAL*/}
      <Modal show={showclient} onHide={closeClient} centered>
        <form onSubmit={updateClient}>
            ...
            <div className="row">
              ...
              <div className="col-12">
                <div className="form-group mb-4">
                  <label htmlFor="">Client type.<strong className="text-danger">*</strong></label>
                  <select
          ...
          <Modal.Footer>
            <Button variant="secondary" className={"btn btn-grey"} onClick={() => closeClient()}>
              Close
            </Button>

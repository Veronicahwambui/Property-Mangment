                  ...
                  <div className="create-property" id="basic-example">
                    ...
                    <section>
                      <form>
                        ...
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label for="landlord-type" class="form-label">
                              Landlord type
                            </label>
                            ...
                            <div class="mb-4 ">
                              ...
                              <div class="input-group" id="datepicker202">
                                <input
                                  ...
                                  data-date-container="#datepicker202"
                        ...
                        <div class="col-12">
                          <div class="bg-primary border-2 bg-soft p-3 mb-4">
                            <p class="fw-semibold mb-0 pb-0 text-uppercase">
                              Banking details and Landlord MCA Property
                              agreement
                            </p>
                          </div>
                        </div>
                          ...
                          <div class="col-lg-4 col-md-6 ">
                            <div class="mb-4 ">
                              ...
                              <select
                                ...
                                id="agreement-type"
                                title="Landlord MCA agreement type"
                              >
                                <option value="Property Management">
                                  Property Management
                                </option>
                                <option value="Unit Letting">
                                  Unit Letting
                                </option>
                                <option value="Service charge collection only">
                                  Service charge collection only
                                </option>
                              </select>
                            </div>
                          </div>
                                  ...
                                  <tr>
                                    ...
                                    >
                                      <span class="d-flex align-items-center ">
                                        ...
                                        <span class="pl-5 ">Add A Bank</span>
                                      </span>
                                    </td>
                                  </tr>
                                </tfoot>

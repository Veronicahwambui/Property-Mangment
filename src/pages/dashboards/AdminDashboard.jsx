                                            ...
                                            <tbody>
                                                {newUnitsIncomeReportCounty === "undefined" ? newUnitsIncomeReport?.unitIncomeModels?.map((model, index) => {
                                                    return (
                                                        <tr>
                                                            <td>{index + 1}</td>
                                                            <td className="text-capitalize">{model.demography?.toLowerCase()?.replace(/_/g , " ")}</td>
                                                            <td>{model.newUnits}</td>
                                                            <td>{model.totalExpectedIncome}</td>
                                                            <td>{model.commissionIncome}</td>
                                                            <td>
                                                                 <i onClick={()=> linkToNewUnits(model.demography)}className="font-size-20 mdi mdi-eye me-3 cursor-pinter "></i>
                                                            </td>
                                                        </tr>
                                                    )
                                                }) :
                                                ...
                                                {adminAgedArrearsMonth === "undefined" ? adminAgedArrears?.ageReportModels?.map((model, index) => {
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td>KSH {model.paid?.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td>
                                                            <td>{model.collectionRate}</td>
                                                            <td>
                                                                 <i onClick={()=> linkToArrears(model.demography)}className="font-size-20 mdi mdi-eye me-3 cursor-pinter "></i>
                                                            </td>
                                                        </tr>
                                                    )
                                                }) :
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{model.countPremiseUnitByStatus?.map(one => (
                                                                <div className="d-flex justify-content-start gap-3">
                                                                    ...
                                                                    <span className="text-capitalize">{one.status?.toLowerCase()?.replace(/_/g , " ")} </span>
                                                                </div>
                                                            ))}</td>
                                                             <td>
                                                                 <i onClick={()=> linkToOccupancyReports(model.demography)}className="font-size-20 mdi mdi-eye me-3 cursor-pinter "></i>
                                                            </td>
                                                        </tr>
                                                    )
                                                }) :

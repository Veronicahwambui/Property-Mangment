...
function OneTenant() {
  ...
  const account = () => {
    ...
    requestsServiceService.createAccount(userId, "TENANT", data).then((res) => {
      fetchAll();
      console.log(res.data);
                ...
                <form onSubmit={createDoc}>
                  ...
                  <Modal.Body>
                    <div className="row">
                      ...
                      {error.color !== "" && (
                        <div
                          className={"mt-2 alert alert-" + error.color}
                          role="alert"
                        >
                          {error.message}
                        </div>
       ...
       <Statement id={userId} entityType={"TENANT"}/>
        ...
        {activeLink === 8 && (
          <>
            ...
            <ViewInvoice
              show={invoice_show2}
              closeInvoice={closeInvoice2}
              activeInvoice={activeInvoice2}
            />
          </>
        )}
                        ...
                        <tr>
                          ...
                          {Object.keys(activeInvoice).length > 0 ? (
                            <>
                              <td>
                                {formatCurrency.format(
                                  JSON.parse(activeInvoice?.response)
                                    .receiptInfo.billAmount
                                )}
                              </td>
                              <td>
                                {formatCurrency.format(
                                  JSON.parse(activeInvoice?.response)
                                    .receiptInfo.billBalance
                                )}
                              </td>
                            </>
                          ) : (

          ...
          <div className="row">
            <div className="col-12">
              <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 className="mb-sm-0 font-size-18 text-capitalize">Landlord Registration</h4>

                <div className="page-title-right">
                  <ol className="breadcrumb m-0">
                    <li className="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li className="breadcrumb-item"><a href="property-list.html">Landlords</a></li>
                        ...
                        <div className="row personal-landlord ">
                          ...
                          <div className="col-lg-3 col-md-6 ">
                            <div className="mb-4 ">
                              ...
                              <input type="text " className="form-control" value={firstName} onChange={(e) => setFirstName(e.target.value)}id="basicpill-firstname-input " placeholder="Enter Your First Name "  required={true}/>
                            </div>
                          </div>
                          <div className="col-lg-3 col-md-6 ">
                            <div className="mb-4 ">
                              <label htmlFor="basicpill-lastname-input ">Last Name <strong className="text-danger ">*</strong></label>
                              <input type="text " className="form-control" value={lastName} onChange={(e) => setLastName(e.target.value)} id="basicpill-lastname-input " placeholder="Enter Your Last Name "  required={true}/>
                            </div>
                          </div>
                          <div className="col-lg-3 col-md-6 ">
                            <div className="mb-4 ">
                        ...
                        <div className="table-responsive table-responsive-md">
                          <table className="table table-editable-file align-middle table-edits">
                            ...
                            <tr className="text-uppercase table-dark">
                              ...
                              <th className="vertical-align-middle">Document owner</th>
